...
tinymce.init({
    ...
    filemanager_title: 'Файл-менеджер',
		external_filemanager_path: '/vendor/assets/responsive-filemanager/filemanager/',
		external_plugins: {
			filemanager: '/vendor/assets/responsive-filemanager/filemanager/plugin.min.js'
		},
		*/
		//
...
<?php
	...
	function editInput($table, $field, $attrs, $value) {
		if (preg_match("~text~", $field["type"]) && preg_match("~_html~", $field["field"])) {
			return "<textarea$attrs class='tinymce-editor' id='fields-" . h($field["field"]) . "' rows='12' cols='50'>" . h($value) . "</textarea>";
/*
			"<script type='text/javascript'>
